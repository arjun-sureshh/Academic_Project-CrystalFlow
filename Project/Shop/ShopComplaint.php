	...
	if(isset($_POST['btn_submit']))
{
	...
	$insqry="insert into tbl_shopcomplaint(scomplaint_title,scomplaint_content,scomplaint_date,shop_id,company_id) value('".$complainttitle."','".$complaintcontent."',curdate(),'".$_SESSION['uid']."','".$_GET['cid']."')";
