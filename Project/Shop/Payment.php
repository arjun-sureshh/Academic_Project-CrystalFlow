...
session_start();
	...
	if(isset($_POST["btn_pay"]))
	{
				...
				if($Conn->query($a))
				{
					$sel="select * from tbl_booking b inner join tbl_shop s on b.shop_id=s.shop_id where booking_id='".$_SESSION['bid']."'";
					...
					$mail->addAddress($row["shop_email"]);
				  
					$mail->isHTML(true);
				  
					$mail->Subject =" Payment confirmation";
					$mail->Body = "your recent payment has been successfully processed.your payment has been debited to our account.if you have any concerns
					              or questions regarding this payment contact us:6806687333
								  Thank you for your prompt payment, and we appreciate your continued business with us";
