	...
	if(isset($_POST['btn_submit']))
{
   ...
   echo $upqry="update tbl_companycomplaint set ccomplaint_replay= '".$complaintcontent."', ccomplaint_status=1 where ccomplaint_id=".$_GET['rep'];
	if($Conn->query($upqry))
	{
		?>
        <script>
		alert("Commented");
		window.location="CComplaintview.php";
		</script>
        <?php
	}
    else
    {
	  ...
	  window.location="CComplaintReplay.php";
	  </script>
      <?php
    }
}
